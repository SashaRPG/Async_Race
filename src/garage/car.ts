export const carPic = (color: string): string => `
...
export const showCar = ({id, name, color, isEngineStarted,}: {
  id: string;
  name: string;
  color: string;
  ...
  <div class="track">
    <div class="controls-container">
      <div class="engine">
        <button class="engine-btn start-engine-btn" id="start-engine-car-${id}" ${isEngineStarted ? 'disabled' : ''}>Start</button>
        <button class="engine-btn stop-engine-btn" id="stop-engine-car-${id}" ${!isEngineStarted ? 'disabled' : ''}>Stop</button>
      </div>
